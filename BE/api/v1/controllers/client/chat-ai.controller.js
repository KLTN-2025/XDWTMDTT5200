...
const { generateAnswer } = require("../../scripts/llm");
const { searchSimilarDocuments } = require("../../scripts/pinecone");
...
//       deleted: false,
//       status: "active"
//     }).select("_id title price discountPercentage sizeStock thumbnail product_category_id brand_id slug");
